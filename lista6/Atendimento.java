...
public abstract class Atendimento implements Registravel{
    ...
    public void registrar(){
        System.out.println("Consulta registrada para " + this.getAnimal().getNome() + " com o veterinário" +  this.getVeterinario().getNome() + ".");
    }
    ...
    public String exibirDados() {
        ...
        dados.append("Valor do atendimento: ").append(this.calcularValor());
